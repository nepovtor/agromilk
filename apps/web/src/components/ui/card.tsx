...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) { return <div className={cn("rounded-2xl border border-[var(--border)] bg-white shadow-[0_10px_35px_-25px_rgba(23,32,51,.32)]", className)} {...props} />; }
